...
myTree.setAbsoluteTime(2023.560274) # need to set this to time of last sampled tip which for our data set is 2021-04-20
...
for k in myTree.Objects: ## iterate over a flat list of branches
    ...
    if 'Region' in k.traits:
        country = k.traits['Region']
    else:
        country = 'UNKNOWN'
        k.traits['Region'] = country
    
    "Find parent country if given"
    if k.parent.traits:
        parent_country = k.parent.traits['Region']
    else:
